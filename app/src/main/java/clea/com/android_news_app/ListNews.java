...
import clea.com.android_news_app.adapter.ListNewsAdapter;
...
public class ListNews extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        diagonalLayout = (DiagonalLayout)findViewById(R.id.diagnoallayout);
        ...
        lstNews = (RecyclerView)findViewById(R.id.first_news);
